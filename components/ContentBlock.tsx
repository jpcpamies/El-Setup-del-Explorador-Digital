    ...
    case 'link':
      ...
      return (
        <a 
          ...
          className={`inline-block mt-3 font-semibold text-sm ${baseColor} relative overflow-hidden transition-all duration-300 ease-in-out border-b-2 border-current hover:text-white group cursor-pointer`}
        >
